...
BlockingQueue<string> sequencerQueue0;
BlockingQueue<string> sequencerQueue1;
BlockingQueue<string> sequencerQueue2;
BlockingQueue<string> sequencerQueue3;
BlockingQueue<string> sequencerQueue4;
...
void chat_handler (char *ip_addr,char *port_num,char *chatMsg) {
	...
	if(strcmp(chatMsg,"DELETE_MEMBER") == 0) {
			...
			hash_fun = atoi(port_num) % 5;
			//cout<<"Message before push"<<msg<<endl;
			switch(hash_fun){
				case 0:
				{
					sequencerQueue0.push(msg);
					break;
				}
				case 1:
				{
					sequencerQueue1.push(msg);
					break;
				}
				case 2:
				{
					sequencerQueue2.push(msg);
					break;
				}
				case 3:
				{
					sequencerQueue3.push(msg);
					break;
				}
				case 4:
				{
					sequencerQueue4.push(msg);
					break;
				}
...
void *print_handler1(void *myvar){
	...
	while(true){
		...
		char temp_seq_num[MESSAGE_SIZE];
 		...
 		char msg[MESSAGE_SIZE];
			...
			strcat(str,"-");
			string msgToSend = sequencerQueue0.front(); 
...
void *print_handler2(void *myvar){
		...
		char temp_seq_num[MESSAGE_SIZE];
 		...
 		char msg[MESSAGE_SIZE];
			...
			sprintf(temp_seq_num,"%d",seq_num);
  			strcat(str,temp_seq_num);
			strcat(str,"-");
			string msgToSend = sequencerQueue1.front(); 
			//cout << "6. sequencerQueue pop: " << msgToSend << endl;
			char *Msg2 = strcpy((char*)malloc((msgToSend).length()+1), (msgToSend).c_str());
			strcat(str,Msg2);
			strcat(str,"-");
...
void *print_handler3(void *myvar){
		...
		char temp_seq_num[MESSAGE_SIZE];
 		...
 		char msg[MESSAGE_SIZE];
			...
			sprintf(temp_seq_num,"%d",seq_num);
  			strcat(str,temp_seq_num);
			strcat(str,"-");
			string msgToSend = sequencerQueue2.front(); 
			//cout << "6. sequencerQueue pop: " << msgToSend << endl;
			char *Msg2 = strcpy((char*)malloc((msgToSend).length()+1), (msgToSend).c_str());
			strcat(str,Msg2);
			strcat(str,"-");
...
void *print_handler4(void *myvar){
		...
		char temp_seq_num[MESSAGE_SIZE];
 		...
 		char msg[MESSAGE_SIZE];
			...
			sprintf(temp_seq_num,"%d",seq_num);
  			strcat(str,temp_seq_num);
			strcat(str,"-");
			string msgToSend = sequencerQueue3.front(); 
			//cout << "6. sequencerQueue pop: " << msgToSend << endl;
			char *Msg2 = strcpy((char*)malloc((msgToSend).length()+1), (msgToSend).c_str());
			strcat(str,Msg2);
			strcat(str,"-");
...
void *print_handler5(void *myvar){
		...
		char temp_seq_num[MESSAGE_SIZE];
 		...
 		char msg[MESSAGE_SIZE];
			...
			sprintf(temp_seq_num,"%d",seq_num);
  			strcat(str,temp_seq_num);
			strcat(str,"-");
			string msgToSend = sequencerQueue4.front(); 
			//cout << "6. sequencerQueue pop: " << msgToSend << endl;
			char *Msg2 = strcpy((char*)malloc((msgToSend).length()+1), (msgToSend).c_str());
			strcat(str,Msg2);
			strcat(str,"-");
...
int main(int argc, char *argv[]) {
	...
	if(argc == 3){
		...
		pthread_create(&th3,NULL,print_handler1,(void*) ipaddress);
		pthread_create(&th7,NULL,print_handler2,(void*) ipaddress);
		pthread_create(&th8,NULL,print_handler3,(void*) ipaddress);
		pthread_create(&th9,NULL,print_handler4,(void*) ipaddress);
		pthread_create(&th10,NULL,print_handler5,(void*) ipaddress);
